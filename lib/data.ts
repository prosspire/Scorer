...
import { IBattleDetail , Icourse, IchapterDetails, IcourseSubmit } from "./types";
...
export const defaultBattle: IBattleDetail = {
  id: "",
  title: "",
  ...
  participant_a_image: "",
  participant_b_image: "",
  participant_a_followers: "",
  participant_b_followers: "",
  description: "",
  status: true,
  creator: "",
  created_at: "",
  ...
  battle_duration: "24",
  category: "general",
  // Optional backend fields with default values
  participant_a_votes: 0,
  participant_b_votes: 0,
  total_votes: 0,
  ends_at: "",
  is_active: true,
};
